...
def generateDataset(data_loader, n=200, num_samples=100, batch_size=1):
    ...
    target_mat     = target_mat[:num_samples,symbol_indices] # (2898, 50, 1), max = 0.4, min = -0.4
    ...
    train_indices    = indices[:train_size] # (2028)
    validate_indices = indices[train_size:train_size+validate_size] # (289)
    test_indices     = indices[train_size+validate_size:] # (581)
